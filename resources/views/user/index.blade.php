...
<section id="dashboard-analytics">
  ...
  <div class="alert alert-danger alert-block">
    ...
    <strong>Lengkapi Data Terlebih Dahulu!</strong> <a href="/profile">Disini.</a>
    @else
    <strong>Harap Tunggu Sebentar, Data anda sedang kami verifikasi!</a>
    @endif
  </div>
  @else
  <div class="row">
      ...
      <div class="card">
        <div class="card-content">
          ...
          <div class="card-img-overlay overflow-hidden overlay-warning overlay-lighten-2">
            <h4 class="card-title text-white">Ingat Kamar Ingat Narali House.</h4>
            <p class="card-text text-white">Cari kamar terbaik dengan ratusan tempat di seluruh Indonesia di Narali House.
            </p>
            <p class="card-text"><small class="text-white">Posted by Narali House</small></p>
          </div>
        </div>
      </div>
    </div>
