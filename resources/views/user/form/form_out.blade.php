            ...
            <div class="card-body">
              <div class="tab-content">
                ...
                {{-- Jika User sebagai penghuni --}}
                  {{-- Profile --}}
                  <div class="mb-5">
                    <h1 class="mb-1">FORM DAFTAR INVENTARIS BARANG KELUAR</h1>

                    <p>
                      Demi kenyamanan anda dapat mengisi form kondisi inventaris barang pada kamar yang sudah anda pilih
                    <a target="_blank" href="/generate-surat-keterangan-keluar/{{$transaction->id}}">Lihat Dokumen</a>
                    </p>
                  </div>
                  
                  <div role="tabpanel" class="tab-pane active" id="data-profile-profile" aria-labelledby="profile-profile" aria-expanded="true">
                    
                    <form action="{{url('user/proses-out-kondisi', $transaction->id)}}" method="POST" enctype="multipart/form-data">
                      @csrf
